...
The final joined dataset was exported as two CSV files because the
complete export exceeded GitHub's individual file-size limit:

-   `task4_join_export_part1.csv`
-   `task4_join_export_part2.csv`

Together, these two files contain the complete joined dataset.
...
The joined SQL dataset was exported as two CSV files because the
complete export exceeded GitHub's individual file-size limit:

-   `task4_join_export_part1.csv`
-   `task4_join_export_part2.csv`

Together, the two files contain **609,283 rows and 7 columns** and were
used as the input for the Python/Pandas stage.
...
The two exported CSV files were loaded into Google Colab using Pandas
and combined into the complete dataset before analysis.
...
### `task4_join_export_part1.csv` and `task4_join_export_part2.csv`

These two files are the split parts of the joined dataset exported from
SQLite. Together they contain the complete dataset used for the
Python/Pandas analysis.
...
4.  Export the complete joined dataset as the two repository files:
    -   `task4_join_export_part1.csv`
    -   `task4_join_export_part2.csv`
...
2.  The notebook automatically loads and combines
    `task4_join_export_part1.csv` and `task4_join_export_part2.csv`.
